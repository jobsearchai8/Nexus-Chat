    ...
    <div className="min-h-screen flex bg-[#F0F2F5]">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        ...
        >
          ...
          {!isDemo && (
            <div className="mb-4">
              {/* GIS will render its official button here */}
              <div ref={googleBtnRef} className="w-full flex justify-center" />
            </div>
          )}

          {/* Demo mode — Google button (no GIS available) */}
          {isDemo && (
            <Button
              variant="outline"
          ...
          <Button
            variant="ghost"
            className="w-full mt-3 text-[#1877F2] hover:text-[#166FE5] hover:bg-[#E7F3FF] font-semibold"
