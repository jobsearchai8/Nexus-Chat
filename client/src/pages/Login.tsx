 ...
 * Uses Supabase OAuth redirect for Google sign-in (most reliable)
 */
...
export default function Login() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // For real mode, the page will redirect to Google OAuth
    } catch (error: any) {
    ...
    <div className="min-h-screen flex bg-[#F0F2F5]">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        ...
        >
          ...
          {/* Google Sign In — styled button that triggers Supabase OAuth redirect */}
          <Button
            variant="outline"
